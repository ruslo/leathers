...
# Test with leathers suppressions (no warning messages expected)
...
# Test without suppressions (warning messages expected)
rm -rf _builds/fortesting
...
diff ${EXPECTED} expected-warnings-on-testing.log
